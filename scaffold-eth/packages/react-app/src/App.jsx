...
import { Hints, Erc20Sandbox, OurApp } from "./views";
...
function App(props) {
  ...
  return (
    <div className="App">
      ...
      <OurApp address={address} localContracts={writeContracts} mainnetProvider={mainnetProvider} />
      {/* <BrowserRouter> */}
      ...
      {/* <Route exact path="/">
            <Erc20Sandbox address={address} localContracts={writeContracts} mainnetProvider={mainnetProvider} />
          </Route> */}
      {/* <Route path="/contract">
